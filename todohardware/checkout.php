				...
				<div class="row">
					...
					<div class="col-md-7">
						...
						<div class="billing-details">
							...
							<div class="form-group">
								<input class="input" type="text" name="address" placeholder="Direccion del Domicilio">
							</div>
							<div class="form-group">
							...
							<div class="form-group">
								<input class="input" type="tel" name="tel" placeholder="Numero de Telefono">
							</div>
							<div class="form-group">
						...
						<div class="shiping-details">
							<div class="section-title">
								<h3 class="title">Informacion Adicional de la Domicilio</h3>
							</div>
							<div class="input-checkbox">
						...
						<div class="order-notes">
							<textarea class="input" placeholder="Ingrese aqui la informacion adicional que vea necesaria para encontrar su domicilio"></textarea>
						</div>
						<!-- /Order notes -->
					</div>
